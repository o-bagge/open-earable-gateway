...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CTLR_POLL_WORK_Q_PRIO, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PREFERRED_MIN_PRES_DLY_US, 3000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF5340_AUDIO_CS47L63_DRIVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF5340_AUDIO_SD_CARD_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CAP_INITIATOR_UNICAST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CAP_INITIATOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GMAP_UGG_SUPPORTED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_BUF_COUNT, 4);
